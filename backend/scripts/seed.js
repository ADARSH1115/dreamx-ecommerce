/**
 * Dev-only product seeder. Run with: npm run seed
 * Replaces the old unauthenticated /api/seed/products HTTP route.
 */
...
const sampleProducts = [
  ...
  },
  {
    ...
    brand: 'StyleCraft',
    images: [{ url: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=800', alt: 'Stylish Leather Jacket' }],
    inStock: true,
    stockQuantity: 25,
    sku: 'FASHION-001',
    specifications: [
  ...
  },
  {
    ...
    subcategory: 'Watches',
    brand: 'FitTech',
    images: [{ url: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=800', alt: 'Smart Fitness Watch' }],
    inStock: true,
    stockQuantity: 75,
    sku: 'WATCH-001',
    specifications: [
  ...
  },
  {
    ...
    brand: 'LuxLight',
    images: [{ url: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800', alt: 'Modern Table Lamp' }],
    inStock: true,
    stockQuantity: 30,
    sku: 'HOME-001',
    specifications: [
  ...
  },
  {
    ...
    subcategory: 'Cameras',
    brand: 'PhotoPro',
    images: [{ url: 'https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=800', alt: 'Professional Camera' }],
    inStock: false,
    stockQuantity: 0,
    sku: 'CAMERA-001',
    specifications: [
  ...
  },
  {
    ...
    brand: 'NaturalGlow',
    images: [{ url: 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?w=800', alt: 'Organic Skincare Set' }],
    inStock: true,
    stockQuantity: 40,
    sku: 'BEAUTY-001',
    specifications: [
  ...
  },
  {
    ...
    brand: 'ErgoComfort',
    images: [{ url: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800', alt: 'Ergonomic Office Chair' }],
    inStock: true,
    stockQuantity: 15,
    sku: 'FURNITURE-001',
    specifications: [
  ...
  },
  {
    ...
    subcategory: 'Audio',
    brand: 'SoundWave',
    images: [{ url: 'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=800', alt: 'Wireless Bluetooth Speaker' }],
    inStock: true,
    stockQuantity: 60,
    sku: 'AUDIO-002',
    specifications: [
...
// Give a handful of on-sale products a live flash-sale window (staggered end
// times), computed at seed time so they're always in the future regardless
// of when this script runs.
const FLASH_SALE_DAYS = [1, 2, 3, 5]
let flashSaleIndex = 0
for (const product of sampleProducts) {
  if (product.onSale && flashSaleIndex < FLASH_SALE_DAYS.length) {
    product.saleEndDate = new Date(Date.now() + FLASH_SALE_DAYS[flashSaleIndex] * 24 * 60 * 60 * 1000)
    flashSaleIndex += 1
  }
}
